...
// ============================================================================
// 11. SOCIAL COMMUNITY & REHEARSAL MOMENTS (INSTAGRAM-STYLE FEED)
// ============================================================================

/**
 * MOMENTS (POSTS)
 * Photos, short rehearsal reels/videos, vocal snippets, and Praise Night highlights.
 */
export const moments = pgTable('moments', {
  ...
  zoneId: text('zone_id').default('hq'),
  zoneName: text('zone_name'),
  type: text('type').default('photo'), // 'photo' | 'video' | 'carousel' | 'audio'
  mediaUrls: jsonb('media_urls'), // Array of { url, thumbnailUrl, type, width, height, duration }
  caption: text('caption'),
  tags: jsonb('tags'), // Array of string tags (e.g. ['#PraiseNight34', '#Sopranos'])
  songId: text('song_id'), // Optional tagged song from masterSongs / songs
...
/**
 * MOMENT LIKES
 * Tracks user likes for moments to prevent duplicate likes and allow quick toggle.
 */
export const momentLikes = pgTable('moment_likes', {
  id: text('id').primaryKey(), // `${momentId}_${userId}`
...
/**
 * MOMENT COMMENTS
 * Discussion, praise comments, and singer interactions under moments.
 */
